...
public class MohistConfig {
    ...
    public static File mohistyml = new File("stackmania-config", "stackmania.yml");
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            Bukkit.getLogger().log(Level.SEVERE, "Could not load stackmania.yml, please correct your syntax errors", ex);
