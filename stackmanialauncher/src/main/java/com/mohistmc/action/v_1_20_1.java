...
public class v_1_20_1 {
    ...
    public static class Install extends Action {
        ...
        public final File stackmaniaplugin;
        ...
        protected Install() throws Exception {
            ...
            this.stackmaniaplugin = new File(libPath, "com/stackmania/stackmaniaplugins/stackmaniaplugins-" + mcVer + ".jar");
        ...
        private void install() throws Exception {
            ...
            copyFileFromJar(stackmaniaplugin, "data/stackmaniaplugins-" + mcVer + ".jar");
